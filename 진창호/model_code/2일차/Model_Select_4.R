...
precipitation_dataset <- precipitation_dataset[!is.na(precipitation_dataset$PM10), ]
...
opt_eps_model <- svm(rental ~ ., data = train_data, type = 'eps-regression', kernel = 'radial')
# model3가 정확도가 가장 높다.
